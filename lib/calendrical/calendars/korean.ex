defmodule Calendrical.Korean do
  @moduledoc """
  ...
  * `true` or `false`.
  ...
  ### Examples
      ...
      iex> Calendrical.Korean.valid_date?(4358, 13, 1)
      true

      iex> Calendrical.Korean.valid_date?(4357, 13, 1)
      false
  ...
  * The number of days in the month, 29 or 30.
  ...
  ### Examples
      ...
      # The intercalary 6th month of Y4358 (= AD 2025)
      iex> Calendrical.Korean.days_in_month(4358, 7)
      29
  ...
  * The number of days from the year's new year to the next.
  ...
  ### Examples
      ...
      iex> Calendrical.Korean.days_in_year(4358)
      384

      iex> Calendrical.Korean.days_in_year(4357)
      354
  ...
  * `{:error, :undefined}` for any other value.
  ...
  ### Examples
      ...
      iex> Calendrical.Korean.days_in_month(1)
      {:ambiguous, 29..30}
  ...
  * `{:error, :invalid_date}`.
  ...
  ### Examples
      ...
      # The lunar new year of Y4358 (= AD 2025) is 2025-01-29
      iex> Calendrical.Korean.iso_days(4358, 1, 1)
      {:ok, 739645}

      iex> Calendrical.Korean.iso_days(4357, 13, 1)
      {:error, :invalid_date}
  ...
  * A `{year, month, day}` tuple of the ordinal date.
  ...
  ### Examples
      ...
      # Dangi 4356 (= AD 2023) has an intercalary 2nd month, so the Mid-Autumn
      # Festival (8th month, 15th day) falls in ordinal month 9
      iex> Calendrical.Korean.plus(4356, 9, 15, :years, 1)
      {4357, 8, 15}
  """
  @impl true
  ...
  @korea_1908 Calendrical.Gregorian.date_to_iso_days(1908, 4, 1)
  @korea_1912 Calendrical.Gregorian.date_to_iso_days(1912, 1, 1)
  @korea_1954 Calendrical.Gregorian.date_to_iso_days(1954, 3, 21)
  @korea_1961 Calendrical.Gregorian.date_to_iso_days(1961, 8, 10)
