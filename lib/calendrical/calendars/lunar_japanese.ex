defmodule Calendrical.LunarJapanese do
  ...
  * `{:error, :undefined}` for any other value.
  ...
  ### Examples
      ...
      iex> Calendrical.LunarJapanese.days_in_month(1)
      {:ambiguous, 29..30}
  ...
  * `{:error, :invalid_date}`.
  ...
  ### Examples
      ...
      # The lunar new year of Y1381 (= AD 2025) is 2025-01-29
      iex> Calendrical.LunarJapanese.iso_days(1381, 1, 1)
      {:ok, 739645}

      iex> Calendrical.LunarJapanese.iso_days(1380, 13, 1)
      {:error, :invalid_date}
  ...
  * A `{year, month, day}` tuple of the ordinal date.
  ...
  ### Examples
      ...
      # 1379 (= AD 2023) has an intercalary 2nd month, so the Mid-Autumn
      # Festival (8th month, 15th day) falls in ordinal month 9
      iex> Calendrical.LunarJapanese.plus(1379, 9, 15, :years, 1)
      {1380, 8, 15}
  """
  @impl true
