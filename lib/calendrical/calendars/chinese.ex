defmodule Calendrical.Chinese do
  ...
  * `{:error, :invalid_month}` for any other value.
  ...
  ### Examples
      ...
      iex> Calendrical.Chinese.ordinal_month_from_traditional(4662, {6, :leap})
      {:ok, 7}

      iex> Calendrical.Chinese.ordinal_month_from_traditional(4662, 7)
      {:ok, 8}

      iex> Calendrical.Chinese.ordinal_month_from_traditional(4661, {6, :leap})
