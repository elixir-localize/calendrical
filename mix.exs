defmodule Calendrical.MixProject do
  ...
  def groups_for_modules do
    [
      ...
      "Lunisolar Calendars":
        ~r/^Calendrical\.(Chinese|Korean|Vietnamese|LunarJapanese|Hebrew|Lunisolar)$/,
      ...
      "Reform Calendars": ~r/^Calendrical\.Reform(\.(Sweden(\.Transitional)?|Japan|England))?$/,
  ...
  defp deps do
    [
      {:localize, github: "elixir-localize/calendrical", branch: "main"},
      {:astro, "~> 2.7"},
