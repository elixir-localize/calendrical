defmodule Calendrical.Islamic.UmmAlQura.AstronomicalTest do
  @moduledoc """
  ExUnit tests for `Calendrical.Islamic.UmmAlQura.Astronomical.first_day_of_month/2`.
  ...
  * **Era 4** (1423 AH onward): conjunction before sunset AND moonset after sunset
  ...
  All expected dates are taken from `Calendrical.Islamic.UmmAlQura.ReferenceData.umm_al_qura_dates/0`,
  ...
  alias Calendrical.Islamic.UmmAlQura.{Astronomical, ReferenceData}
